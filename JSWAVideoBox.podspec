#
#  Be sure to run `pod spec lint WAVideoBox.podspec' to ensure this is a
...
Video Edit Tool
 ...
 # spec.license      = "MIT (example)"
  ...
  spec.author             = { "Jason" => "xm98357@163.com" }
  # Or just: spec.author    = "Jason"
  # spec.authors            = { "Jason" => "xm98357@163.com" }
  ...
  spec.source       = { :git => "https://github.com/CoderJasonSu/WAVideoBox.git", :tag => "#{spec.version}" }
